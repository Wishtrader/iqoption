...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts'], function() {
    ...
    gulp.watch('app/css/*.css', browserSync.reload); // Наблюдение за sass файлами в папке scss
    gulp.watch('app/*.html', browserSync.reload); // Наблюдение за HTML файлами в корне проекта
    gulp.watch('app/js/**/*.js', browserSync.reload); // Наблюдение за JS файлами в папке js
    gulp.watch('app/pages/*.pug', ['pug']); // Наблюдение за PUG файлами в папке app
});
...
gulp.task('build', ['clean', 'img', 'sass', 'scripts'], function() {
    ...
    var buildVideo = gulp.src('app/videos/*.*') // Переносим VIDEO в продакшен
